...
//    auto mesh = LocalRefiner::refineAndCreateMesh(frameVecRef,config);
//    auto pcd = LocalRefiner::refineAndCreateMPointCloud(frameVecRef,config);
    std::shared_ptr<geometry::PointCloud> pcd;
//    GeometryMethods::createPointCloundFromFrames(frameVector,config,pcd);
